                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2 text-center">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">설문조사 리스트</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <div class="container">
    <form method="POST" action="/project/survey/survey.proj" id="frm" name="frm">
		<input type="hidden" name="user_id" value="${SID}">
		<input type="hidden" name="sino" id="sino" value="0">
		<input type="hidden" name="title" id="title" value="0">
	</form>
	<div class="w3-content mxw750 w3-margin-top">
		<h1 class="w3-margin-top w3-padding w3-blue w3-card-4 w3-center">진행중인 설문조사</h1>
		<div class="w3-col w3-margin-top w3-padding">
<c:forEach var="data" items="${LIST}" varStatus="st">
			<h4 class="w3-col pdAll10 w3-text-grey w3-round-large w3-card-2 w3-center w3-hover-amber w3-border w3-border-amber slist" id="${data.sino}">
