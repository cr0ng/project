...
<body>
<form method="POST" action="/project/movie/genreList.proj"  id="frm" name="frm">
		...
		<input type="hidden" name="gno" id="gno" value="0">
		<input type="hidden" name="gnum" id="gnum" value="${GNO}">
</form>
    ...
    <main>
       ...
       <aside class="single_sidebar_widget post_category_widget">
					...
					<c:forEach var="data" items="${GLIST}">
									<li>
										<span class="inblock w150 w3-text-grey gbtn" id="gno${data.gno}">
