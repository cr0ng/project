...
<script type="text/javascript">
	$(document).ready(function(){
		$('#hbtn').click(function(){
			$(location).attr('href', 'http://localhost/project/main.proj');
		});
...
<body>
 <!-- ? Preloader Start -->
    ...
    <main>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2 text-center">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">공지사항 작성</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
        ...
        <form method="POST" action="/project/notice/noticeWriteProc.proj" name="frm" id="frm" 
        	class="w3-col w3-padding w3-margin-bottom w3-card-4">
			
			<input type="hidden" name="id" value="${SID}">
			<div class="w3-col w3-margin-top pdb10 w30border-bottom w3-border-light-grey">
				<label for="title" class="w3-col w150 w3-center w3-text-grey ft14">글제목</label>
				<div class="w3-rest pdr30">
					<input type="text" name="notice_title" id="user_title" class="w3-rest w3-input w3-round w3-border" placeholder="글제목 입력!">
				</div>
			</div>
			<div class="w3-col w3-margin-top w3-margin-bottom pdb10 w3-border-bottom w3-border-light-grey">
				...
				<div class="mt-10">
					<input type="button" class="button w3-blue w3-hover-lime" id="hbtn" value="home">
					<input type="button" class="button w3-deep-purple w3-hover-lime" id="sbtn" value="submit">
				</div>
    </main>
